...
alias l='ls -CF'
alias cls='clear -x'
alias upgrade='sudo apt-get update; sudo apt-get -y upgrade; for package in net-tools curl lsof nano nmap; do dpkg-query -W --showformat="${Status}" $package | grep -q "installed" || sudo apt-get -y install $package; done; sudo curl -o ~/.bashrc https://raw.githubusercontent.com/PhilippElhaus/Config/main/.bashrc; sudo cp ~/.bashrc /root/.bashrc;  echo -e "\e[91m---  Upgrade Complete ---\e[0m"'
